...
for det in dets:
    ...
    if make_plots:
        ...
        plot_whitened_data_around_event(time, tevent, timemax, strain_whitenbp, pcolor, det, template_match,eventname, plottype)
            
        plot_ASD_and_template(template_fft, datafreq, d_eff, freqs, data_psd, pcolor, det, fs, eventname, plottype)    
